...
def deporteesPrintMonth(subDepor):
        index = 0
        arrayMonth = []
        timeData = TimeMonth()
...
"""
        ...
        def Oprtion():
            for pic in timeData:
                ...
                count = StationMonthSqly.get_Deportees("month",pic,subDepor['nameSorting'])
            ...
            html = f"""
                <tr>
                    <th class="headerselect"  colspan="17">تقرير عن المرحلين من  {subDepor['nameSorting']} </th>
                """
            html +=  f""" 
                            <thead>
                                <tbody>
